...
public interface StudentRepository {
        ...
        public List<StudentWebRespDTO.StudentConsultDTO> findStudentConsultByStudentId(
                        @Param("studentId") String studentId);
        ...
        void updatePendingHanTeacher(
                        @Param("studentId") String studentId,
                        @Param("centerCode") String centerCode,
                        @Param("userCode") String userCode);

        void updatePendingBookTeacher(
                        @Param("studentId") String studentId,
                        @Param("centerCode") String centerCode,
                        @Param("userCode") String userCode);
        ...
        List<StudentTransferSchedule> findScheduleByIds(@Param("ids") List<Integer> ids);

        void cancelTransferSchedule(@Param("ids") List<Integer> ids);

        void clearPendingHanTeacher(@Param("studentId") String studentId);

        void clearPendingBookTeacher(@Param("studentId") String studentId);
        ...
        List<StudentWebRespDTO.PrivacyStudentListDTO> findStudentList(
                        @Param("centerCode") String centerCode,
                        @Param("yy") String yy,
                        @Param("mm") String mm,
                        @Param("search") String search);

        List<StudentWebRespDTO.PrivacyConsentDocDTO> findConsentDocList(
                        @Param("centerCode") String centerCode,
