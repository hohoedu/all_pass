...
public class PopbillService {
        ...
        public String getChargeUrl(String centerCode) throws PopbillException {

                PopbillConfig popbillConfig = popbillRepository.findPopbillConfig(centerCode);
                KakaoService kakaoService = serviceFactory.getKakaoService(centerCode);
                String url = kakaoService.getChargeURL(
                                popbillConfig.getCorpNumber(),
                                popbillConfig.getPopbillId());
                return url;
        }

        public PopbillReqDTO.InviteTrackingReqDTO sendJoinAlimtalk(String centerCode, String phone, String regionName,
                        String centerName, String userCode) {
                ...
                try {
                        ...
                        PopbillConfig config = popbillRepository.findPopbillConfig(centerCode);
                        PopbillRespDTO.PopbillTemplateRespDTO respDTO = popbillRepository
                                        .findPopbillTemplate(centerCode, category);
                        ...
                        String joinUrl = "https://hohocenter.co.kr/student/mobile/join?centerCode=" + centerCode
                                        + "&invite=" + inviteCode;
                        // String joinUrl =
                        // "https://45e2-106-246-14-212.ngrok-free.app/student/mobile/join?centerCode="
                        // + centerCode + "&invite=" + inviteCode;
        ...
        public String sendJoinCompletionAlimtalk(String centerCode, String teacherPhone, String parentPhone,
                        String userCode, StudentWebReqDTO.StudentJoinDTO studentDTO) {
        ...
        public String sendAddReorderAlimtalk(UserRespDTO.LoginRespDTO user, String orderContent) {
                ...
                try {
                        ...
                        PopbillRespDTO.PopbillTemplateRespDTO respDTO = popbillRepository.findPopbillTemplate("PUS001",
                                        category);
                ...
                try {
                        ...
                        for (PopbillReqDTO.RemindReqDTO.RemindStudentDTO student : request.getStudents()) {
                                try {
                                        ...
                                        // 발송 로그 저장
                                        PopbillReqDTO.PopbillSendLogReqDTO sendLogDTO = PopbillReqDTO.PopbillSendLogReqDTO
                                                        .builder()
                                                        .sendKey(sendKey)
                                                        .userCode("SYSTEM")
