...
public interface PaymentRepository {
        ...
        Payment findByStudentAndYm(@Param("studentId") String studentId, @Param("year") String year,
                        @Param("month") String month);
        ...
        // ======================================== //
        // i-with 납부내역 조회
        List<PaymentAppRespDTO.PaymentDetailRespDTO> findPaymentDetailsByStudentId(@Param("studentId") String studentId,
        ...
        List<PaymentRespDTO.CashbillPrintDTO> findCashbillPrint(@Param("ym") String ym,
                        @Param("centerCode") String centerCode);
