 ...
 * 재사용(replay) 방지는 서명과 별개로 sso_ticket 테이블(book_clinic과 공유하는 DB)에서
...
public class SsoTokenUtil {
    ...
    private static final String ISSUER = "all-pass";
    ...
    public String issue(String userId, String redirectUrl) {
        ...
        ssoTicketRepository.insert(jti, ISSUER, userId, safeRedirectUrl, LocalDateTime.ofInstant(exp, KST));
